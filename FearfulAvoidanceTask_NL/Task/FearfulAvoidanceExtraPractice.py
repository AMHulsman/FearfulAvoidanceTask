...
# Global settings
#------------------------------------------------------------------------------
exp = expyriment.design.Experiment(name="Fearful Avoidance Task Extra Practice") # create new experiment
...
# Text ready?
text_ready = expyriment.stimuli.TextScreen("",text="Druk op het pijltje naar boven of beneden drukken om de extra oefenrondes te starten. Let op: de oefenrondes starten meteen.",text_size=30,text_colour=(85,85,85),position=(0,0))
